...
class SparsityParameters(object):
    ...
    def DimMetadata(self, j):
        ...
        if o != 0:
            ...
            from tflite_.DimensionMetadata import DimensionMetadata
...
def SparsityParametersEnd(builder):
    ...
    return End(builder)
import tflite_.DimensionMetadata
try:
...
class SparsityParametersT(object):
    ...
    def __init__(self):
        ...
        self.dimMetadata = None  # type: List[tflite_.DimensionMetadata.DimensionMetadataT]
        ...
        if not sparsityParameters.DimMetadataIsNone():
            ...
            for i in range(sparsityParameters.DimMetadataLength()):
                if sparsityParameters.DimMetadata(i) is None:
                    ...
                    dimensionMetadata_ = tflite_.DimensionMetadata.DimensionMetadataT.InitFromObj(sparsityParameters.DimMetadata(i))
