...
def QuantizationParametersEnd(builder):
    ...
    return End(builder)
import tflite_.CustomQuantization
import tflite_.QuantizationDetails
try:
...
class QuantizationParametersT(object):
    ...
    def __init__(self):
        ...
        self.details = None  # type: Union[None, tflite_.CustomQuantization.CustomQuantizationT]
    ...
    def _UnPack(self, quantizationParameters):
        ...
        self.details = tflite_.QuantizationDetails.QuantizationDetailsCreator(self.detailsType, quantizationParameters.Details())
