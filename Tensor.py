...
class Tensor(object):
    ...
    def Quantization(self):
        ...
        if o != 0:
            ...
            from tflite_.QuantizationParameters import QuantizationParameters
    ...
    def Sparsity(self):
        ...
        if o != 0:
            x = self._tab.Indirect(o + self._tab.Pos)
            from tflite_.SparsityParameters import SparsityParameters
...
def TensorEnd(builder):
    ...
    return End(builder)
import tflite_.QuantizationParameters
import tflite_.SparsityParameters
try:
...
class TensorT(object):
    ...
    def __init__(self):
        ...
        self.quantization = None  # type: Optional[tflite_.QuantizationParameters.QuantizationParametersT]
        self.isVariable = False  # type: bool
        self.sparsity = None  # type: Optional[tflite_.SparsityParameters.SparsityParametersT]
    ...
    def _UnPack(self, tensor):
        ...
        if tensor.Quantization() is not None:
            self.quantization = tflite_.QuantizationParameters.QuantizationParametersT.InitFromObj(tensor.Quantization())
        self.isVariable = tensor.IsVariable()
        if tensor.Sparsity() is not None:
            self.sparsity = tflite_.SparsityParameters.SparsityParametersT.InitFromObj(tensor.Sparsity())
