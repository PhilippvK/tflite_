...
import tflite_.SparseIndexVector
...
class DimensionMetadataT(object):
    ...
    def __init__(self):
        ...
        self.arraySegments = None  # type: Union[None, tflite_.Int32Vector.Int32VectorT, tflite_.Uint16Vector.Uint16VectorT, tflite_.Uint8Vector.Uint8VectorT]
        self.arrayIndicesType = 0  # type: int
        self.arrayIndices = None  # type: Union[None, tflite_.Int32Vector.Int32VectorT, tflite_.Uint16Vector.Uint16VectorT, tflite_.Uint8Vector.Uint8VectorT]
    ...
    def _UnPack(self, dimensionMetadata):
        ...
        self.arraySegments = tflite_.SparseIndexVector.SparseIndexVectorCreator(self.arraySegmentsType, dimensionMetadata.ArraySegments())
        self.arrayIndicesType = dimensionMetadata.ArrayIndicesType()
        self.arrayIndices = tflite_.SparseIndexVector.SparseIndexVectorCreator(self.arrayIndicesType, dimensionMetadata.ArrayIndices())
