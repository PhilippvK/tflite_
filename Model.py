...
class Model(object):
    ...
    def OperatorCodes(self, j):
        ...
        if o != 0:
            ...
            from tflite_.OperatorCode import OperatorCode
            obj = OperatorCode()
    ...
    def Subgraphs(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from tflite_.SubGraph import SubGraph
            obj = SubGraph()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Buffers(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from tflite_.Buffer import Buffer
            obj = Buffer()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
    ...
    def Metadata(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from tflite_.Metadata import Metadata
            obj = Metadata()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
def ModelEnd(builder):
    ...
    return End(builder)
import tflite_.Buffer
import tflite_.Metadata
import tflite_.OperatorCode
import tflite_.SubGraph
try:
...
class ModelT(object):
    ...
    def __init__(self):
        ...
        self.operatorCodes = None  # type: List[tflite_.OperatorCode.OperatorCodeT]
        self.subgraphs = None  # type: List[tflite_.SubGraph.SubGraphT]
        self.description = None  # type: str
        self.buffers = None  # type: List[tflite_.Buffer.BufferT]
        self.metadataBuffer = None  # type: List[int]
        self.metadata = None  # type: List[tflite_.Metadata.MetadataT]
        ...
        if not model.OperatorCodesIsNone():
            ...
            for i in range(model.OperatorCodesLength()):
                if model.OperatorCodes(i) is None:
                    ...
                    operatorCode_ = tflite_.OperatorCode.OperatorCodeT.InitFromObj(model.OperatorCodes(i))
        ...
        if not model.SubgraphsIsNone():
            ...
            for i in range(model.SubgraphsLength()):
                if model.Subgraphs(i) is None:
                    ...
                    subGraph_ = tflite_.SubGraph.SubGraphT.InitFromObj(model.Subgraphs(i))
        ...
        if not model.BuffersIsNone():
            ...
            for i in range(model.BuffersLength()):
                if model.Buffers(i) is None:
                    ...
                    buffer_ = tflite_.Buffer.BufferT.InitFromObj(model.Buffers(i))
        ...
        if not model.MetadataIsNone():
            ...
            for i in range(model.MetadataLength()):
                if model.Metadata(i) is None:
                    ...
                    metadata_ = tflite_.Metadata.MetadataT.InitFromObj(model.Metadata(i))
    ...
    def Pack(self, builder):
        if self.operatorCodes is not None:
            ...
            StartOperatorCodesVector(builder, len(self.operatorCodes))
        ...
        if self.subgraphs is not None:
            ...
            StartSubgraphsVector(builder, len(self.subgraphs))
        ...
        if self.metadataBuffer is not None:
            if np is not None and type(self.metadataBuffer) is np.ndarray:
                ...
                StartMetadataBufferVector(builder, len(self.metadataBuffer))
        ...
        if self.metadata is not None:
            ...
            StartMetadataVector(builder, len(self.metadata))
        ...
        if self.operatorCodes is not None:
            AddOperatorCodes(builder, operatorCodes)
        if self.subgraphs is not None:
            AddSubgraphs(builder, subgraphs)
        if self.description is not None:
            AddDescription(builder, description)
        if self.buffers is not None:
            AddBuffers(builder, buffers)
        if self.metadataBuffer is not None:
            AddMetadataBuffer(builder, metadataBuffer)
        if self.metadata is not None:
