...
class SubGraph(object):
    ...
    def Tensors(self, j):
        ...
        if o != 0:
            ...
            from tflite_.Tensor import Tensor
            obj = Tensor()
    ...
    def Operators(self, j):
        ...
        if o != 0:
            ...
            x += flatbuffers.number_types.UOffsetTFlags.py_type(j) * 4
            x = self._tab.Indirect(x)
            from tflite_.Operator import Operator
            obj = Operator()
            obj.Init(self._tab.Bytes, x)
            return obj
        return None
...
def SubGraphEnd(builder):
    ...
    return End(builder)
import tflite_.Operator
import tflite_.Tensor
try:
...
class SubGraphT(object):
    ...
    # SubGraphT
    def __init__(self):
        self.tensors = None  # type: List[tflite_.Tensor.TensorT]
        self.inputs = None  # type: List[int]
        self.outputs = None  # type: List[int]
        self.operators = None  # type: List[tflite_.Operator.OperatorT]
        ...
        if not subGraph.TensorsIsNone():
            ...
            for i in range(subGraph.TensorsLength()):
                if subGraph.Tensors(i) is None:
                    ...
                    tensor_ = tflite_.Tensor.TensorT.InitFromObj(subGraph.Tensors(i))
        ...
        if not subGraph.OperatorsIsNone():
            ...
            for i in range(subGraph.OperatorsLength()):
                if subGraph.Operators(i) is None:
                    ...
                    operator_ = tflite_.Operator.OperatorT.InitFromObj(subGraph.Operators(i))
